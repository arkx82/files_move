        ...
        try:
            ...
            for f in lists:
                try:
                    ...
                    #logger.debug('p:%s', p)
                    if os.path.isfile(p):
                        if u'poster.jpg' in f or u'poster.png' in f or u'movie.nfo' in f or u'fanart.jpg' in f or u'fanart.png' in f or u'info.json' in f:
                    ...
                    if (daum_movie_info and daum_movie_info[0]['score'] >= 100):
                        ...
                        if 'more' in daum_movie_info[1] and daum_movie_info[1] is not None:
                            if 'eng_title' in daum_movie_info[1]['more']:
                                logger.debug('cml - movie %s:%s', item['guessit']['title'], daum_movie_info[1]['more']['eng_title'])
